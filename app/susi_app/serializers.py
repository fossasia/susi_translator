...
class TranscribeInputSerializer(serializers.Serializer):
    ...
    source_type = serializers.ChoiceField(
        choices=['mic', 'file', 'url', 'stdin'],
        required=False,
        default='mic',
        help_text='Audio source type'
    )
...
class TranscribeResponseSerializer(serializers.Serializer):
    ...
    source_type = serializers.CharField(help_text='Audio source type')
...
class TranscriptResponseSerializer(serializers.Serializer):
    ...
    translated = serializers.CharField(
        ...
        allow_blank=True,
        default='',
        help_text='Translated text (NLLB-200)'
    )
...
class LanguageConfigSerializer(serializers.Serializer):
    tenant_id = serializers.CharField(required=False, default='0000')
    source_lang = serializers.CharField(required=False, default='en', help_text='Whisper language code')
    target_lang = serializers.CharField(required=False, default='eng_Latn', help_text='NLLB BCP-47 tag')
